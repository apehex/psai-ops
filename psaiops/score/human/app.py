...
TITLE = '''Human Scoring'''
INTRO = list((__t, _LEGEND.get(__t, '50')) for __t in '''Leverages an open source LLM as critic to take apart the text sections written by a human from those generated by an AI .'''.split(' '))
