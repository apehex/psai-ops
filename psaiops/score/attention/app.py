...
def create_model_block() -> dict:
    ...
    return {'model': __model_dd, 'layer': __layer_sl, 'head': __head_sl}
...
def create_sampling_block() -> dict:
    ...
    return {'tokens': __tokens, 'topk': __topk, 'topp': __topp}

# MODE #########################################################################

# def create_metric_block() -> dict:
#     __metric = gradio.Radio(label='Mode', value='Attention', choices=['Attention', 'Shapley', 'Similarity'], interactive=True)
...
def create_display_block() -> dict:
    ...
    return {'display': __display}

# INPUTS #######################################################################

def create_inputs_block() -> dict:
    __input = gradio.Textbox(label='Prompt', value='', placeholder='A string of tokens to score.', lines=4, interactive=True)
...
def create_actions_block() -> dict:
    ...
    return {'process': __process, 'position': __position}
        ...
        with gradio.Tabs():
            ...
            with gradio.Tab('Settings'):
                with gradio.Column(scale=1):
                    ...
                    with gradio.Row():
                        # fields.update(create_metric_block())
