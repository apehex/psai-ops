...
def create_model_block() -> dict:
    ...
    __layer = gradio.Slider(label='Layer Depth', value=15, minimum=0, maximum=31, step=1, scale=1, interactive=True)
    return {
        'model_block': __model,
        'layer_block': __layer,}
...
def create_table_block() -> dict:
    __table = gradio.DataFrame(label='Summary', type='numpy', headers=None,  row_count=4, column_count=256, scale=1, interactive=False)
